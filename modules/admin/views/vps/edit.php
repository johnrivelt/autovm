...
<?php $list = range(1, 30);?>
	    <?php echo $form->field($model, 'reset_at')->dropDownList($list)->label('Day for Bandwidth reset');?>
            ...
            <?php echo $form->field($model, 'vps_ram')->label('RAM');?>
            <?php echo $form->field($model, 'vps_cpu_mhz')->label('CPU Mhz');?>
            <?php echo $form->field($model, 'vps_cpu_core')->label('CPU Core');?>
            <?php echo $form->field($model, 'vps_hard')->label('Hard');?>
            <?php echo $form->field($model, 'vps_band_width')->label('Bandwidth(MB)');?>
